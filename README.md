...
Passionate Software Developer with 3.8+ years of experience in Python, Django, and Django Rest Framework. Skilled in PostgreSQL, MySQL, and various AWS services (RDS, EC2, S3, Cognito, API Gateway, SQS, Lambda). Actively seeking opportunities in backend, cloud-based architecture, and full stack development, AI/ML role. Proficient in Celery, HTML, CSS, Bootstrap, and Vue.js 3. Eager to contribute to innovative projects and collaborate with talented teams to deliver high-quality software solutions.
